        ...
        <Navbar.Collapse id="navbarScroll" className="d-flex col-8">
          ...
          >
            ...
            <NavDropdown title="Medias" id="navbarScrollingDropdown">
              ...
              <NavLink to="/producto/medias/search/marca/puma" className={({ isActive }) => (isActive ? 'active nav-item' : 'inactive')}>Puma</NavLink>
              <NavLink to="/producto/medias/search/marca/nike" className={({ isActive }) => (isActive ? 'active nav-item' : 'inactive')}>Nike</NavLink>         
              <NavLink to="/producto/medias/search/marca/adidas" className={({ isActive }) => (isActive ? 'active nav-item' : 'inactive')}>Adidas</NavLink>  
            </NavDropdown>      
